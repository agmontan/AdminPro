...
export const pagesRoutes: Routes = [
          ...
          { path: 'convocatories', component: ConvocatoryComponent, data: {titulo: 'Convocatorias web'}  },
          { path: 'convocatory/:id', component: ConvocatoryFormComponent, data: {titulo: 'Formulario de convocatorias web'}  },
